...
from requests.views import RequestAPIView, RequestAcceptAPIView, RejectRequestAPIView, RequestCollectedAPIView
from requests.api.api import request_list, requests_availables, accepted_request, requests_availables_recycler, requests_made_recycler, requests_all_recycler
...
urlpatterns = [
     ...
     path('collected_request/',RequestCollectedAPIView.as_view(), name = 'collected_requests_api'),
     ...
     path('requests_all_recycler/<int:pk>/',requests_all_recycler, name = 'requests_all_recycler_request_api'),
]
