...
def publication_count(request):
    ...
    if request.method == 'GET':
        ...
        requests_accepted = Request.objects.filter(publication__state = False, state = "Aceptada").count()
        requests_rejected = Request.objects.filter(publication__state = False, state = "Rechazada").count()
        requests_rejected_available = Request.objects.filter(publication__state = True,is_active = True, state = "Rechazada").count()
        data = {
